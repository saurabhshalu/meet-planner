      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="space-x-4">
              <button
                ...
                className="bg-indigo-600  text-white text-sm font-semibold  py-2 px-4 rounded text-center inline-flex items-center"
              >
              {" "}
                Google{" "}
              </button>
            ...
            <div className="space-x-4 pt-10">
              <button
                ...
                className="bg-indigo-600  text-white text-sm font-semibold  py-2 px-4 rounded text-center inline-flex items-center"
              >
                <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-sm font-semibold text-blue-800 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-blue-400">
